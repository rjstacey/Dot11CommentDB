...
function validContent(content: any): content is Content {
	return (
		...
		(typeof content.Data === "undefined" ||
			typeof content.Data === "string") &&
		(typeof content.Charset === "undefined" ||
			typeof content.Charset === "string")
	);
}

function validDestination(destintation: any): destintation is Destination {
	return (
		isPlainObject(destintation) &&
...
export function validateEmail(email: any): asserts email is Email {
	if (!isPlainObject(email)) throw new TypeError("expected email object");
...
function validEmailTemplateCreate(
	template: any
): template is EmailTemplateCreate {
	return (
		isPlainObject(template) &&
		(typeof template.subject === "undefined" ||
			typeof template.subject === "string") &&
		(typeof template.body === "undefined" ||
			typeof template.body === "string")
	);
}

export function validEmailTemplateCreates(
	templates: any
): templates is EmailTemplateCreate[] {
	return (
		Array.isArray(templates) && templates.every(validEmailTemplateCreate)
	);
}
...
function validEmailTemplateChanges(
	changes: any
): changes is Partial<EmailTemplate> {
	return (
		isPlainObject(changes) &&
		(typeof changes.subject === "undefined" ||
			typeof changes.subject === "string") &&
		(typeof changes.body === "undefined" ||
...
export function validEmailTemplateUpdates(
	updates: any
): updates is EmailTemplateUpdate[] {
