...
export type StoreType = typeof store; //ReturnType<typeof configureStore>['store'];
export type RootState = ReturnType<typeof rootReducer> //ReturnType<typeof configureStore>['reducer']>;
