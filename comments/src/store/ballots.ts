...
export const fields = {
	...
	Type: {label: 'Type', type: FieldType.NUMERIC, options: BallotTypeOptions, dataRenderer: renderBallotType},
	Stage: {label: 'Stage'},
	IsRecirc: {label: 'Stage', type: FieldType.NUMERIC, options: BallotStageOptions, dataRenderer: renderBallotStage},
