...
ColorPicker.defaultProps = {
	options: ['red','cyan','#9AFEFF','DarkBlue','purple','yellow','lime', '#6CC417', 'magenta','pink',
		'silver','orange','brown','maroon','green', '#46C7C7', 'olive','aquamarine', '#728FCE', 'Turquoise', '#FFDB58', '#FFE5B4', '#FF69B4', '#86608E', '#FAF0DD']
